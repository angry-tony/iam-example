    ...
    <div class="search-block-v2">
        <div class="container">
            <div class="col-md-8 col-md-offset-2">
                <c:choose>
                    <c:when test="${invalid}">
                        <h2> <uengine:message code="license.notserverkey1"></uengine:message> <br> <uengine:message code="license.notserverkey2"></uengine:message> <a href="#"> <uengine:message code="license.notserverkey3"></uengine:message> </a> <uengine:message code="license.notserverkey4"></uengine:message> </h2>
                    </c:when>

                    <c:when test="${duplicated}">
                        <h2><uengine:message code="license.duplicate.trial.1"></uengine:message> <br> <uengine:message code="license.duplicate.trial.2"></uengine:message> <a href="#"> <uengine:message code="license.duplicate.trial.3"></uengine:message> </a> <uengine:message code="license.duplicate.trial.4"></uengine:message> </h2>
                    </c:when>

                    <c:otherwise>
                        <h2><uengine:message code="license.enter.key"></uengine:message> </h2>
                    </c:otherwise>
                </c:choose>

                <form action="/license/createTrial" method="post" id="serverIdinputForm">
                    <div class="row">
                        <div class="col-md-3">
